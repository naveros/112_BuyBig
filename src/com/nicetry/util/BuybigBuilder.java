...
import com.nicetry.service.BookService;
import com.nicetry.service.OrderService;
import com.nicetry.service.PurchaseService;
import com.nicetry.service.UserService;
	...
	public int getNbBooks(){
		...
		try {
			List<Book> allBooks = (List<Book>) getBookService().getAllBooks(
					this.getSession(), "IDBOOK");
					return allBooks.size();
		} catch (InvalidHibernateSessionException
